...
const navItems = {
  ...
  manager: [
    ...
    { label: "Live Coaching", icon: "🎙️", href: "/dashboard/live-coaching" },
    { label: "Compliance", icon: "🛡️", href: "/dashboard/compliance" },
    { label: "Coaching", icon: "🎯", href: "/dashboard/coaching" },
    { label: "Advanced Coaching", icon: "🏅", href: "/dashboard/advanced-coaching" },
    ...
    { label: "AI Assistant", icon: "🧠", href: "/dashboard/ai-assistant" },
    { label: "Role Play Center", icon: "🎭", href: "/dashboard/roleplay-center" },
    { label: "Coaching Academy", icon: "📚", href: "/dashboard/academy" },
    { label: "Coaching Automation", icon: "⚡", href: "/dashboard/coaching-automation" },
    { label: "Advanced Analytics", icon: "📊", href: "/dashboard/advanced-analytics" },
    { label: "Executive Coaching", icon: "📈", href: "/dashboard/executive-coaching" },
