  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        <div className="relative w-full sm:w-auto">
          <input
            type="text"
            placeholder="Search..."
            className="w-32 sm:w-56 md:w-64 lg:w-80 rounded-lg px-3 sm:px-4 py-2 sm:py-2 pl-8 sm:pl-10 text-xs sm:text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-purple-500/50"
            style={{
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        {/* Notifications */}
        <button className="relative rounded-lg p-2.5 sm:p-2 text-gray-400 transition-colors hover:bg-white/5">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="rounded-lg px-3 sm:px-3 py-2 sm:py-1.5 text-xs sm:text-sm text-gray-400 transition-colors hover:bg-white/5 hover:text-red-400"
          >
            Logout
          </button>
        </div>
