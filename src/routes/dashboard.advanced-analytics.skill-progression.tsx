  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1"><h1 className="text-2xl font-bold text-ink">Skill Progression</h1><p className="text-sm text-ink-muted">Track skill development over time</p></div>
        <select value={selectedSkill} onChange={(e) => setSelectedSkill(e.target.value)} className="rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-focus/40">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
          <h3 className="text-lg font-semibold text-ink mb-4">Progression Over Time</h3>
          <div className="h-48">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
          <h3 className="text-sm font-semibold text-ink mb-4">Trend Summary</h3>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-ink-faint">Current Avg</span>
              <span className="text-lg font-bold text-ink">76%</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-ink-faint">3 Months Ago</span>
              <span className="text-lg font-bold text-ink-muted">62%</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-ink-faint">Overall Change</span>
              <span className="text-lg font-bold text-green-600">+14%</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-ink-faint">vs Team Avg</span>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        {repProgression.map((rep, i) => (
          <div key={i} className="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-900">
            <p className="text-sm font-medium text-ink mb-2">{rep.name}</p>
            <div className="flex items-center gap-2 mb-2">
              <span className="text-2xl font-bold text-ink">{rep.current}%</span>
            ...
            <div className="flex items-center gap-1 text-xs text-ink-faint mb-2">
              <span className="text-ink-muted">Prev: {rep.prev}%</span>
            </div>
