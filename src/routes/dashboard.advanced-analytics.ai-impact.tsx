...
function AIImpact() {
  ...
  const summary = [
    { label: "AI-Coached Reps", value: "18", change: "+6", color: "from-accent-500 to-accent-600" },
  ...
  const attribution = [
    { factor: "AI Live Coaching", percent: 35, color: "bg-accent-500" },
    { factor: "AI Roleplay", percent: 25, color: "bg-accent-500" },
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div><h1 className="text-2xl font-bold text-ink">AI Coaching Impact</h1><p className="text-sm text-ink-muted">Measure the impact of AI-powered coaching</p></div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
          <h3 className="text-lg font-semibold text-ink mb-4">Improvement Attribution</h3>
          <div className="space-y-3">
            {attribution.map((item, i) => (
              <div key={i}>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-sm text-ink-muted">{item.factor}</span>
                  <span className="text-sm font-bold text-ink">{item.percent}%</span>
                </div>
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
          <h3 className="text-lg font-semibold text-ink mb-4">AI-Coached vs Non-AI-Coached</h3>
          <div className="space-y-4">
            {comparison.map((c, i) => (
              <div key={i}>
                <div className="flex items-center justify-between mb-1">
                  <span className="text-sm font-medium text-ink">{c.skill}</span>
