  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1"><h1 className="text-2xl font-bold text-ink">Rep Improvement</h1><p className="text-sm text-ink-muted">Track individual rep coaching progress</p></div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-900">
          <h3 className="text-lg font-semibold text-ink mb-4">Improvement Timeline</h3>
          <div className="h-48">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
          <h3 className="text-sm font-semibold text-ink mb-4">Coaching Impact</h3>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center justify-between border-b border-gray-100 pb-2 dark:border-gray-800 last:border-0">
                ...
                <span className={`text-sm font-bold ${s.color || "text-ink"}`}>{s.value}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="rounded-2xl glass-subtle transition-all duration-300">
        <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
          <h3 className="text-lg font-semibold text-ink">Skill-by-Skill Breakdown</h3>
        </div>
            ...
            <div key={i} className="px-6 py-4 transition-colors hover:bg-white/[0.02]">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-xs text-ink-muted">Before: {s.before}%</span>
                  <span className="text-xs font-bold text-green-600">+{s.change}</span>
                  <span className="text-xs text-ink-muted">After: {s.after}%</span>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="flex-1 h-3 rounded-full bg-white/[0.06] relative overflow-hidden">
                  <div className="h-3 rounded-full bg-accent-300" style={{ width: `${s.before}%` }} />
