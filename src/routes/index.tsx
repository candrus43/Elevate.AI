        ...
        <div className="mx-auto mt-3 sm:mt-4 flex max-w-5xl items-center justify-between rounded-2xl border border-edge bg-panel/80 px-4 sm:px-6 py-2.5 sm:py-3 backdrop-blur-xl">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-3">
              <Button size="sm" variant="secondary" href="/login">Launch Demo</Button>
          ...
          <div className="mx-auto mt-2 max-w-5xl rounded-2xl border border-edge bg-panel/95 p-3 animate-fade-in backdrop-blur-xl md:hidden">
            <div className="flex flex-col">
              ...
              <div className="mt-2 flex flex-col gap-2 border-t border-edge pt-3">
                <Button variant="secondary" href="/login" fullWidth>Launch Demo</Button>
    ...
    <div className="mt-6 sm:mt-8 grid grid-cols-2 sm:flex sm:flex-wrap items-center justify-center gap-2 sm:gap-3 w-full max-w-xs sm:max-w-none mx-auto sm:mx-0">
      {cards.map((card, i) => (
        ...
        >
          ...
          <svg className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-accent-fg transition-transform duration-300 group-hover:translate-x-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <section className="relative min-h-[70vh] sm:min-h-screen overflow-hidden pt-20 sm:pt-24">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
        <div className="flex flex-col items-center pt-12 sm:pt-16 text-center">
          ...
          {/* Headline */}
          <h1 className="mt-4 sm:mt-6 max-w-4xl text-3xl font-extrabold leading-tight tracking-tight text-ink sm:text-6xl md:text-7xl">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col items-center gap-3 sm:flex-row sm:gap-4 w-full max-w-xs sm:max-w-none mx-auto sm:mx-0 sm:justify-center">
            <Button size="lg" variant="secondary" href="/login" className="w-full sm:w-auto">
              Launch Demo
            </Button>
            <Button size="lg" href="/register" className="w-full sm:w-auto" rightIcon={
            ...
            <Button size="lg" variant="outline" href="/demo.html" target="_blank" className="w-full sm:w-auto">
              Watch demo
            </Button>
          </div>
          ...
          <p className="mt-3 flex items-center justify-center gap-1.5 text-xs sm:text-sm text-ink-faint">
            <svg className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  return (
    <section id="dashboard-preview" className="relative py-16 sm:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
        ...
        {/* Mockup */}
        <div className="mt-16 overflow-hidden rounded-2xl border border-edge bg-panel">
          <div className="flex">
            {/* Sidebar Mockup */}
            <div className="hidden w-56 flex-shrink-0 border-r border-edge bg-panel-raised/40 p-4 sm:block">
              ...
              {["Dashboard", "Calls", "Scorecards", "Coaching", "Analytics", "Team"].map((item, i) => (
                <div key={i} className={`mb-1 flex items-center gap-2 rounded-lg px-3 py-2 ${i === 0 ? "bg-accent-500/15" : "hover:bg-panel-raised"}`}>
                  <div className={`h-2 w-2 rounded-full ${i === 0 ? "bg-accent-400" : "bg-ink-faint"}`} />
                  <span className={`text-xs ${i === 0 ? "font-medium text-accent-300" : "text-ink-muted"}`}>{item}</span>
                </div>
              ))}
            </div>
            ...
            <div className="min-w-0 flex-1 p-4 sm:p-6">
              ...
              <div className="mb-4">
                ...
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="mb-2 flex items-center justify-between rounded-lg bg-panel-raised/60 px-4 py-3">
                    <div className="flex items-center gap-3">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          <div className="flex items-start gap-3 rounded-xl border border-edge bg-panel p-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-ink-faint">Live call metrics, conversion rates, and team performance at a glance</p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-xl border border-edge bg-panel p-4">
            <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-accent-500/15 text-accent-fg">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-ink-faint">Full transcripts with AI analysis, sentiment scoring, and keyword detection</p>
            </div>
          </div>
          <div className="flex items-start gap-3 rounded-xl border border-edge bg-panel p-4">
            <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-accent-500/15 text-accent-fg">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-ink-faint">AI-powered grading with customizable rubrics and performance trends</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 text-center">
          <Button size="lg" href="/login" rightIcon={
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
            </svg>
          }>
          ...
          <p className="mt-3 text-sm text-ink-faint">Sign in to access the full dashboard experience</p>
        </div>
      </div>
    </section>
  );
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
        ...
        <div className="mt-12 sm:mt-16 grid gap-6 sm:gap-8 lg:grid-cols-3">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`relative rounded-2xl border bg-panel p-8 ${
                plan.popular ? "border-accent-500/60 ring-2 ring-accent-500/40" : "border-edge"
              }`}
            >
              {plan.popular && (
              ...
              <p className="mt-1 text-xs text-ink-faint">Billed monthly per manager seat</p>
              <ul className="mt-8 space-y-3">
                {plan.features.map((feature, i) => (
                  <li key={i} className="flex items-start gap-3 text-sm text-ink-muted">
                    <svg className="mt-0.5 h-4 w-4 flex-shrink-0 text-accent-fg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    ...
    <section id="how-it-works" className="relative py-16 sm:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-8 lg:px-12">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {steps.map((s) => (
            <div key={s.step} className="rounded-2xl border border-edge bg-panel p-6">
              <span className="text-sm font-bold text-accent-fg">{s.step}</span>
    ...
    <section id="faq" className="relative py-16 sm:py-32">
      ...
      <div className="relative mx-auto max-w-3xl px-4 sm:px-8 lg:px-12">
        ...
        <div className="mt-12 sm:mt-16 space-y-3 sm:space-y-4">
          {faqs.map((faq, i) => (
            <details key={i} className="group rounded-2xl border border-edge bg-panel transition-all duration-300 open:bg-panel-raised/40">
              <summary className="flex cursor-pointer items-center justify-between p-6 text-sm font-semibold text-ink transition-colors hover:text-accent-fg [&::-webkit-details-marker]:hidden">
                {faq.question}
                <svg className="h-5 w-5 flex-shrink-0 text-ink-faint transition-transform duration-300 group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-edge bg-panel p-8 sm:p-16 text-center">
          ...
          <div className="relative">
            ...
            <div className="mt-8 sm:mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
              <Button size="lg" href="/register" rightIcon={
                <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
              }>
            ...
            <p className="mt-4 text-sm text-ink-faint">14-day free trial · No credit card · Cancel anytime</p>
          </div>
        </div>
      </div>
    </section>
