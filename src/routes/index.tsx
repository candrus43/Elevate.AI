      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        <div className="glass mx-auto mt-4 flex max-w-5xl items-center justify-between rounded-2xl px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="/register" className="btn-primary text-xs px-4 py-2">
              Get started
            </a>
          </div>
        </div>
  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-24">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute top-1/4 right-0 h-[300px] w-[300px] rounded-full bg-indigo-500/10 blur-[100px]" />
        <div className="absolute bottom-0 left-0 h-[400px] w-[400px] rounded-full bg-violet-600/10 blur-[120px]" />
      </div>

      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        <div className="flex flex-col items-center pt-16 text-center">
          {/* Badge */}
          <div className="glass inline-flex animate-fade-in items-center gap-2 rounded-full px-4 py-1.5 text-sm text-gray-400">
            <span className="flex h-2 w-2 rounded-full bg-green-500" />
            AI-Powered Sales Coaching
          </div>

          {/* Headline */}
          <h1 className="mt-6 max-w-4xl text-5xl font-extrabold leading-tight tracking-tight sm:text-6xl md:text-7xl">
            Turn Every Sales Call Into A{" "}
            <span className="gradient-text-hero">Coaching Opportunity</span>
          </h1>
          ...
          <div className="mt-16 w-full max-w-5xl animate-fade-up">
            <div className="glass-card relative overflow-hidden rounded-2xl p-2 shadow-2xl">
              <img
...
function FeaturesSection() {
  ...
  return (
    <section id="features" className="relative py-24 sm:py-32">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-1/2 left-0 h-[400px] w-[400px] -translate-y-1/2 rounded-full bg-purple-600/10 blur-[120px]" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature, index) => (
            <div key={index} className="glass-card group rounded-2xl p-6" style={{ animationDelay: `${index * 100}ms` }}>
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-purple-500/20 to-indigo-600/20 text-purple-400 ring-1 ring-purple-500/20">
                {feature.icon}
              </div>
...
function PricingSection() {
  ...
  return (
    <section id="pricing" className="relative py-24 sm:py-32">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-1/3 right-0 h-[500px] w-[500px] rounded-full bg-indigo-600/10 blur-[120px]" />
      </div>
...
function FAQSection() {
  ...
  return (
    <section id="faq" className="relative py-24 sm:py-32">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute bottom-0 left-1/2 h-[400px] w-[400px] -translate-x-1/2 rounded-full bg-violet-600/10 blur-[120px]" />
      </div>
  ...
  return (
    <section id="demo" className="relative py-24 sm:py-32">
      ...
      <div className="relative mx-auto max-w-4xl px-6 sm:px-8 lg:px-12">
        <div className="glass-card relative overflow-hidden rounded-3xl p-12 text-center sm:p-16">
