  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-ink">Skill Gap Analysis</h1>
          <p className="text-sm text-ink-faint dark:text-ink-muted">AI-identified skill gaps across your team</p>
        </div>
      </div>
          ...
          <div key={ci} className="rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-900">
            <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4 dark:border-gray-700">
              <div className="flex items-center gap-3">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-ink">{cat.category}</h3>
              ...
              {cat.skills.map((skill, si) => (
                <div key={si} className="px-6 py-3.5 hover:bg-gray-50 dark:hover:bg-gray-800">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-sm font-medium text-gray-900 dark:text-ink">{skill.name}</span>
                    <div className="flex items-center gap-3 text-xs">
                      <span className="text-ink-faint">Team: <strong className="text-gray-900 dark:text-ink">{skill.repAvg}%</strong></span>
                      <span className="text-ink-faint">Target: <strong>{skill.benchmark}%</strong></span>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1 h-2 rounded-full bg-gray-200 dark:bg-gray-700">
                      <div className="h-2 rounded-full bg-gradient-to-r from-accent-500 to-accent-500" style={{ width: `${skill.repAvg}%` }} />
                    </div>
                    <div className="flex-1 h-2 rounded-full bg-gray-200 dark:bg-gray-700">
