...
function ExecutiveCoachingDashboard() {
  ...
  const kpis = [
    ...
    { label: "Team Improvement", value: "68%", change: "+12%", color: "from-accent-500 to-accent-600" },
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-ink">Executive Coaching Dashboard</h1>
          <p className="text-sm text-ink-muted mt-1">Coaching effectiveness metrics and organizational insights</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <GlassCard className="lg:col-span-2">
          <GlassCardHeader>
            <h3 className="text-lg font-semibold text-ink">Coaching Effectiveness Trend</h3>
          </GlassCardHeader>
          <GlassCardBody>
        ...
        <GlassCard>
          <GlassCardHeader>
            <h3 className="text-sm font-semibold text-ink">Manager Effectiveness</h3>
          </GlassCardHeader>
              ...
              <GlassCardRow key={i}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-ink-faint">{m.team}</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm font-bold text-ink">{m.effectiveness}%</p>
