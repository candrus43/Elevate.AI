  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-ink">Coaching Automation</h1>
          <p className="text-sm text-ink-muted mt-1">Automate coaching workflows and stay on top of your team</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <GlassCard className="lg:col-span-2">
          <GlassCardHeader>
            <div className="flex items-center gap-2">
              <h3 className="font-semibold text-ink">Daily Briefing</h3>
          ...
          <GlassCardBody>
            <div className="p-5 sm:p-6 space-y-4">
              <div>
                <p className="text-xs font-semibold text-ink-muted uppercase tracking-wider mb-2">Today's Priorities</p>
              ...
              <div className="rounded-xl p-4" style={{ background: "rgba(139, 92, 246, 0.08)", border: "1px solid rgba(139, 92, 246, 0.15)" }}>
                <p className="text-xs font-medium text-accent-300 mb-0.5">AI-Generated Summary</p>
                <p className="text-sm text-accent-200/70">{dailyBriefing.summary}</p>
              </div>
            </div>
          </GlassCardBody>
        </GlassCard>
        ...
        <div className="space-y-3">
          <Link to="/dashboard/coaching-automation/briefings" className="block rounded-2xl p-4 sm:p-5 transition-all duration-300 hover:border-accent-500/25 hover:translate-y-[-1px]"
            style={{
            ...
            <p className="text-sm font-medium text-ink">Weekly Report</p>
            <p className="text-xs text-ink-muted mt-0.5">Generate and schedule reports</p>
          ...
          <Link to="/dashboard/coaching-automation/briefings" className="block rounded-2xl p-4 sm:p-5 transition-all duration-300 hover:border-accent-500/25 hover:translate-y-[-1px]"
            ...
            <span className="text-lg block mb-1">📅</span>
            <p className="text-sm font-medium text-ink">Monthly Report</p>
            <p className="text-xs text-ink-muted mt-0.5">Due in 5 days</p>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <GlassCard>
          <GlassCardHeader>
            <h3 className="text-sm font-semibold text-ink">Upcoming Reminders</h3>
            <Link to="/dashboard/coaching-automation/reminders" className="text-xs text-accent-300 hover:text-accent-300">View All</Link>
          </GlassCardHeader>
        ...
        <GlassCard>
          <GlassCardHeader>
            ...
            <Link to="/dashboard/coaching-automation/alerts" className="text-xs text-accent-300 hover:text-accent-300">View All</Link>
          </GlassCardHeader>
          <GlassCardBody divide>
            {alerts.map((a, i) => (
              <GlassCardRow key={i} hover={false}>
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-ink-faint mt-0.5">{a.time}</p>
                  </div>
                </div>
              </GlassCardRow>
            ))}
        ...
        <GlassCard>
          <GlassCardHeader>
            <h3 className="text-sm font-semibold text-ink">Coaching Tasks</h3>
            <Link to="/dashboard/coaching-automation/tasks" className="text-xs text-accent-300 hover:text-accent-300">View All</Link>
          </GlassCardHeader>
          <GlassCardBody divide>
            {tasks.map((t, i) => (
              <GlassCardRow key={i} hover={false}>
                <div className="flex items-start justify-between gap-2 w-full">
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      <span className="text-[10px] text-ink-faint">{t.assignee}</span>
                    </div>
                  </div>
